// Generated from /Users/wujianchao5/project/jd/antlr-demo/src/main/java/woo/sql/parser/DemoDBLex.g4 by ANTLR 4.10.1
...
public class DemoDBLex extends Lexer {
	...
	public static final int
		...
		PROPERTY=232, QUARTER=233, QUERY=234, QUOTA=235, RANDOM=236, RANGE=237, 
		RANK=238, READ=239, RECOVER=240, REFRESH=241, REGEXP=242, RELEASE=243, 
		RENAME=244, REPAIR=245, REPEATABLE=246, REPLACE=247, REPLACE_IF_NOT_NULL=248, 
		REPLICA=249, REPOSITORY=250, REPOSITORIES=251, RESOURCE=252, RESOURCES=253, 
		RESTORE=254, RESUME=255, RETURNS=256, REVOKE=257, REVERT=258, RIGHT=259, 
		RLIKE=260, ROLE=261, ROLES=262, ROLLBACK=263, ROLLUP=264, ROUTINE=265, 
		ROW=266, ROWS=267, ROW_NUMBER=268, SAMPLE=269, SCHEMA=270, SCHEMAS=271, 
		SECOND=272, SELECT=273, SEMI=274, SERIALIZABLE=275, SESSION=276, SET=277, 
		SETS=278, SET_VAR=279, SIGNED=280, SHOW=281, SMALLINT=282, SNAPSHOT=283, 
		SQLBLACKLIST=284, START=285, STATS=286, STATUS=287, STOP=288, STORAGE=289, 
		STRING=290, SUBMIT=291, SUM=292, SYNC=293, SYSTEM=294, SWAP=295, TABLE=296, 
		TABLES=297, TABLET=298, TASK=299, TEMPORARY=300, TERMINATED=301, THAN=302, 
		THEN=303, TIME=304, TIMESTAMP=305, TIMESTAMPADD=306, TIMESTAMPDIFF=307, 
		TINYINT=308, TRANSACTION=309, TO=310, TRACE=311, TRIGGERS=312, TRUE=313, 
		TRUNCATE=314, TYPE=315, TYPES=316, UNBOUNDED=317, UNCOMMITTED=318, UNION=319, 
		UNIQUE=320, UNINSTALL=321, UNSIGNED=322, UPDATE=323, USE=324, USER=325, 
		USING=326, VALUE=327, VALUES=328, VARCHAR=329, VARIABLES=330, VERBOSE=331, 
		VIEW=332, WARNINGS=333, WEEK=334, WHEN=335, WHERE=336, WHITELIST=337, 
		WITH=338, WORK=339, WRITE=340, YEAR=341, EQ=342, NEQ=343, LT=344, LTE=345, 
		GT=346, GTE=347, EQ_FOR_NULL=348, PLUS_SYMBOL=349, MINUS_SYMBOL=350, ASTERISK_SYMBOL=351, 
		SLASH_SYMBOL=352, PERCENT_SYMBOL=353, LOGICAL_OR=354, LOGICAL_AND=355, 
		LOGICAL_NOT=356, INT_DIV=357, BITAND=358, BITOR=359, BITXOR=360, BITNOT=361, 
		ARROW=362, AT=363, INTEGER_VALUE=364, DECIMAL_VALUE=365, DOUBLE_VALUE=366, 
		SINGLE_QUOTED_TEXT=367, DOUBLE_QUOTED_TEXT=368, LETTER_IDENTIFIER=369, 
		DIGIT_IDENTIFIER=370, QUOTED_IDENTIFIER=371, BACKQUOTED_IDENTIFIER=372, 
		SIMPLE_COMMENT=373, BRACKETED_COMMENT=374, SEMICOLON=375, DOTDOTDOT=376, 
		WS=377;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STORAGE", "STRING", "SUBMIT", "SUM", "SYNC", "SYSTEM", "SWAP", "TABLE", 
			"TABLES", "TABLET", "TASK", "TEMPORARY", "TERMINATED", "THAN", "THEN", 
	...
	public DemoDBLex(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "DemoDBLex.g4"; }
